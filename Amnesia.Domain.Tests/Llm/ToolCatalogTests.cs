...
[{"type":"function","function":{"name":"attempt_action","description":"Descrive un tentativo fisico del personaggio. Azioni non supportate restano impraticabili.","parameters":{"type":"object","properties":{"action":{"type":"string"},"target":{"type":"string"},"means":{"type":"string"}},"required":["action","target"]}}},{"type":"function","function":{"name":"end_conversation","description":"Chiude la conversazione dal lato del personaggio.","parameters":{"type":"object","properties":{"reason":{"type":"string"}},"required":["reason"]}}},{"type":"function","function":{"name":"dichiaro","description":"Segnala che il tuo personaggio ha appena detto una di queste cose. Scegli l'identificativo che corrisponde a cio' che hai detto; se non ne corrisponde nessuno, non chiamarlo.","parameters":{"type":"object","properties":{"id":{"type":"string","enum":["circolo_esisteva","scampagnate","non_erano_gite","padre_nel_circolo","magazzino_dove","versione_paese","elena_figlia_vittorio","corpo_mai_trovato","il_rito","sacrificio_per_vittorio","elena_prescelta","laura_non_cera","laura_assoggettata","anna_solo_matteo","padre_nella_cava","io_ero_con_lui","matteo_ero_gia_sceso","matteo_la_porto_via","elena_viva","matteo_non_dice_dove","matteo_confessa","dove_lo_trovai","wanda_una_persona_sola","elena_adottata","frase_per_riconoscersi","vittorio_morto","vittorio_capo","nino_giacca","giacca_e_di_matteo","padre_ricerche","andrea_cercava_elena","giorgio_continuo_ricerche"]}},"required":["id"]}}}]
""";
